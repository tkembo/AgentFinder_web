...
<div class='notifsholder'>
	<div class="notifs">
		<p>Get directions to the nearest TeleCash Agent from your current location using the buttons below: </p>	
	</div>
</div>
...
function print_locs($locs){
	GLOBAL $flat, $flng, $n1lat, $n1lng, $n2lat, $n2lng;
	$maps_url = "http://agentfinder.co/telecash/eaf_directions.php"; 
