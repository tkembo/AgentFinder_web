	...
	function map_initialize()
	{
			...
			$.get("map_process.php", function (data) {
				$(data).find("marker").each(function () {
					  ...
					  create_marker(point, name, address, false, false, false, "http://agentfinder.co/telecash/icons/pin_blue.png");
				});
			});	
			...
			google.maps.event.addListener(map, 'rightclick', function(event) {
				...
				create_marker(event.latLng, 'New Marker', EditForm, true, true, true, "http://agentfinder.co/telecash/icons/pin_green.png");
			});
	...
	function save_marker(Marker, mName, mAddress, mType, replaceWin)
	{
		...
		$.ajax({
		  ...
		  success:function(data){
				...
				Marker.setIcon('http://agentfinder.co/telecash/icons/pin_blue.png'); //replace icon
            },
            error:function (xhr, ajaxOptions, thrownError){
                alert(thrownError); //throw any errors
            }
